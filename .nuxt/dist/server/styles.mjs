...
import style_8 from './_nuxt/headerSection-styles-1.mjs.5d928e61.js';
...
export default {
  ...
  "components/headerSection.vue": () => import('./_nuxt/headerSection-styles.995c36aa.mjs').then(interopDefault),
