...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$f], ["__scopeId", "data-v-179f42ee"]]);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$8], ["__scopeId", "data-v-079a3fe0"]]);
...
const meta$2 = void 0;
const loading_vue_vue_type_style_index_0_scoped_c59e24bc_lang = "";
const _sfc_main$2 = {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.7c8fb24b.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.ceb02a34.js").then((m) => m.default || m)
  },
  {
    name: "user-userid",
    path: "/user/:userid",
    ...
    component: () => import("./_nuxt/_userid_.b9ad8d4e.js").then((m) => m.default || m)
  },
  {
    name: "user",
    path: "/user",
    ...
    component: () => import("./_nuxt/index.6e124904.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.109cdaee.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
