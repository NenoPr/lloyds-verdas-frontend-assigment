import { defineComponent, h, inject, computed, unref, Suspense, Transition, provide, reactive, getCurrentInstance, ref, resolveComponent, mergeProps, withCtx, createVNode, useSSRContext, shallowRef, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, nextTick, watchEffect } from 'file:///home/neno/WebProjects/lloyds-verdas-frontend-assigment/node_modules/vue/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index.d9c2fb85.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index.a4c75fc1.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.9bf52397.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
